...
<div
    ...
    @else
        ...
        <div class="mt-4 flex h-2 w-full overflow-hidden rounded-full bg-neutral-100 dark:bg-zinc-800">
            <div class="bar-fill bar-grow h-full bg-emerald-500 dark:bg-emerald-400" style="width: {{ round($compliantPct) }}%"></div>
            <div class="bar-fill bar-grow h-full bg-amber-400 dark:bg-amber-500" style="width: {{ round($unknownPct) }}%"></div>
            <div class="bar-fill bar-grow h-full bg-red-500 dark:bg-red-400" style="width: {{ round($nonCompliantPct) }}%"></div>
        </div>
