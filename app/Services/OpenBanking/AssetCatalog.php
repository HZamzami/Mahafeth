...
class AssetCatalog
{
    ...
    private const ASSETS = [
        ...
        '7010.SR' => ['name' => 'stc Group', 'name_ar' => 'مجموعة stc', 'asset_class' => 'equity', 'sector' => 'Communication Services', 'country' => 'SA', 'currency' => 'SAR', 'shariah_status' => 'compliant', 'start' => 10.5, 'drift' => 0.07, 'vol' => 0.20, 'loading' => 0.35],
