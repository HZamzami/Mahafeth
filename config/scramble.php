...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'The Mahafeth mobile app API — token-authenticated JSON endpoints for the React Native client. The web app (Livewire/Volt) does not use this API.',
    ],
